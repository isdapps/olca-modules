...
public class ProcessName {
	...
	private String quantitativeFlowProperties; 
	
	
	/*
	 * General information.Base name
	 */
	...
	public String getQuantitativeFlowProperties() {
		return quantitativeFlowProperties;
	}

	public void setQuantitativeFlowProperties(String quantitativeFlowProperties) {
		this.quantitativeFlowProperties = quantitativeFlowProperties;
	}
